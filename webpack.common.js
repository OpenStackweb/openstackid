...
module.exports = {
    ...
    */
    entry: {
        ...
        editUser: './resources/js/admin/edit_user/edit_user_wrapper.js',
        emailVerification: './resources/js/email_verification/email_verification_wrapper.js',
        forgotPassword: './resources/js/forgot_password/forgot_password.js',
        home: './resources/js/home/home.js',
        login: './resources/js/login/login_wrapper.js',
        profile: './resources/js/profile/profile_wrapper.js',
        resetPassword: './resources/js/reset_password/reset_password_wrapper.js',
        setPassword: './resources/js/set_password/set_password.js',
        signup: './resources/js/signup/signup_wrapper.js',
    },
    output: {
        filename: '[name].js',
