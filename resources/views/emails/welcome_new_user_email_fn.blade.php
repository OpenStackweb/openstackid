...
<p>You will use this account to access all {!! Config::get('app.tenant_name') !!} apps that require an {!! Config::get('app.app_name') !!}  to access. Your user details are associated with your {!! Config::get('app.app_name') !!} and you are able to grant access to that information to each app at your discretion.</p>
