...
<form id="form-application-security-logout" name="form-application-security-logout">
    ...
    <div class="checkbox">
        <label>
            <input type="checkbox" id="logout_session_required" name="logout_session_required"
                   @if ($client->logout_session_required)
                   checked
                   @endif>Session Required (Optional)&nbsp;<span class="glyphicon glyphicon-info-sign accordion-toggle" aria-hidden="true" title=""></span>
        </label>
    </div>
    <div class="checkbox">
        <label>
            <input type="checkbox" id="logout_use_iframe" name="logout_use_iframe"
                   @if ($client->logout_use_iframe)
                   checked
                   @endif>Use IFrame (Optional)&nbsp;<span class="glyphicon glyphicon-info-sign accordion-toggle" aria-hidden="true" title=""></span>
        </label>
    </div>
