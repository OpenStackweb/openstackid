...
const HomePage = ({ appName, appLogo, infoBannerContent, showInfoBanner, signInUrl, signUpUrl, tenantName }) => {
  return (
    <Container component="main" maxWidth="xs" className={styles.main_container}>
      ...
      >
        ...
        <CardContent>
          ...
          >
            <Grid item>
              <Button variant="outlined" size="large" href={signInUrl} className={styles.button}>
                Sign in to your account
              </Button>
            </Grid>
            <Grid item>
              <Button variant="outlined" size="large" href={signUpUrl} className={styles.button}>
